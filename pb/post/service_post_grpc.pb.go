...
const (
	...
	PostService_GetPostsListing_FullMethodName = "/pb.PostService/GetPostsListing"
...
type PostServiceClient interface {
	...
	GetPostsListing(ctx context.Context, in *GetPostsListingRequest, opts ...grpc.CallOption) (*GetPostsListingResponse, error)
...
func (c *postServiceClient) GetPostsListing(ctx context.Context, in *GetPostsListingRequest, opts ...grpc.CallOption) (*GetPostsListingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPostsListingResponse)
	err := c.cc.Invoke(ctx, PostService_GetPostsListing_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PostServiceServer interface {
	...
	GetPostsListing(context.Context, *GetPostsListingRequest) (*GetPostsListingResponse, error)
...
func (UnimplementedPostServiceServer) GetPostsListing(context.Context, *GetPostsListingRequest) (*GetPostsListingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPostsListing not implemented")
}
...
func _PostService_GetPostsListing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPostsListingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PostServiceServer).GetPostsListing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostService_GetPostsListing_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).GetPostsListing(ctx, req.(*GetPostsListingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PostService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPostsListing",
			Handler:    _PostService_GetPostsListing_Handler,
		},
		{
	...
	Metadata: "post/service_post.proto",
}
